...
export function SageGreeting() {
  return (
    <Card className="relative overflow-hidden bg-forest-50 dark:bg-forest-800/50 border-emerald-500/20 backdrop-blur-sm p-8 mb-8">
      ...
      <div className="relative">
        ...
        {/* Greeting Message */}
        <h1 className="text-3xl md:text-4xl font-light text-forest-900 dark:text-forest-50 mb-3 leading-relaxed">
          Hey friend, planning something special?
        </h1>

        <p className="text-sage-600 dark:text-sage-400 text-lg">
          I'm Sage Riverstone. Let's figure out your event's carbon footprint together with clarity and actionable steps.
        </p>
      </div>
    </Card>
  );
