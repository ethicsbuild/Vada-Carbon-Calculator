...
export function InfluenceScoreResults({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 border-slate-700/50 backdrop-blur-sm p-8">
        <div className="text-center space-y-4">
          <div className="flex items-center justify-center gap-2">
            <Target className="w-6 h-6 text-emerald-400" />
            <h2 className="text-2xl font-bold text-white">Your Influence Score</h2>
          </div>
          ...
          <div className="bg-slate-900/50 rounded-lg p-4 max-w-2xl mx-auto">
            <p className="text-slate-400 text-xs leading-relaxed">
              ...
              Your Influence Score measures how well you're performing on the things you <strong className="text-white">CAN control</strong>. 
      ...
      <Tabs defaultValue="high" className="w-full">
        <TabsList className="grid w-full grid-cols-3 bg-slate-800/50">
          ...
          <TabsTrigger 
            value="low" 
            className="data-[state=active]:bg-slate-500/20 data-[state=active]:text-slate-400"
          >
          ...
          <Card className="bg-slate-800/50 border-emerald-500/30 p-6">
            <div className="space-y-4">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">High Control Areas</h3>
              ...
              <div className="bg-slate-900/50 rounded-lg p-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-slate-300 font-medium">Total High-Control Emissions</span>
        ...
        <TabsContent value="medium" className="mt-6">
          <Card className="bg-slate-800/50 border-yellow-500/30 p-6">
            <div className="space-y-4">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Medium Control Areas</h3>
                  <p className="text-slate-400 text-sm">
              ...
              <div className="bg-slate-900/50 rounded-lg p-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-slate-300 font-medium">Total Medium-Control Emissions</span>
        ...
        <TabsContent value="low" className="mt-6">
          <Card className="bg-slate-800/50 border-slate-600/30 p-6">
            <div className="space-y-4">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Context: Low Control Areas</h3>
                  <p className="text-slate-400 text-sm">
              ...
              <div className="bg-slate-900/50 rounded-lg p-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-slate-300 font-medium">Total Low-Control Emissions</span>
