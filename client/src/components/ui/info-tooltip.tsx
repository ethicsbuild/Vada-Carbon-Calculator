...
export function InfoTooltip({ content, title }: InfoTooltipProps) {
  ...
  return (
    <div className="relative inline-block">
      ...
      {isOpen && (
        <div className="absolute z-50 bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-64 p-3 bg-slate-900 border border-emerald-500/30 rounded-lg shadow-xl">
          ...
          <div className="absolute top-full left-1/2 transform -translate-x-1/2 -mt-1">
            <div className="w-2 h-2 bg-slate-900 border-r border-b border-emerald-500/30 transform rotate-45"></div>
          </div>
        </div>
      )}
    </div>
