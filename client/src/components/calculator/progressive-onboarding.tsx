...
export function ProgressiveOnboarding({ onComplete, eventType }: ProgressiveOnboardingProps) {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <Card className="bg-forest-50 dark:bg-forest-800/50 border-forest-200 dark:border-forest-700/50 backdrop-blur-sm p-8 max-w-2xl w-full">
        {/* Progress Bar */}
        <div className="mb-8">
            ...
            <div className="grid gap-4 mt-8">
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="text-3xl">🎯</div>
                  <div>
                    <h3 className="text-xl font-semibold text-forest-900 dark:text-forest-50 mb-2 group-hover:text-violet-400 transition-colors">
        ...
        {step === 3 && (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-sage-700 dark:text-sage-300 text-lg mb-6">
              ...
              {eventType && (
                <div className="bg-sage-50 dark:bg-forest-900/50 rounded-lg p-4 mb-6">
                  <div className="text-sm text-sage-600 dark:text-sage-400 mb-1">Starting with:</div>
                  <div className="text-xl font-semibold text-forest-900 dark:text-forest-50">
            ...
            <div className="flex gap-3">
              ...
              <Button
                ...
                className="flex-1 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-forest-900 dark:text-forest-50"
              >
                Let's Calculate!
