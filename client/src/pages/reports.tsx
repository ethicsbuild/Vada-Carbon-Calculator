                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    >
                      <div className="flex items-start">
                        ...
                        />
                        <div>
                          <div className="font-medium text-gray-900 dark:text-white">GHG Protocol Report</div>
                    ...
                    >
                      <div className="flex items-start">
                        ...
                        />
                        <div>
                          <div className="font-medium text-gray-900 dark:text-white">Carbon Receipt</div>
                          <div className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900 dark:text-white">Verified on Hedera</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900 dark:text-white">NFT Generation</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900 dark:text-white">Traceable Offsets</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900 dark:text-white">DAO Ready</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900 dark:text-white">Verra Integration</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">
